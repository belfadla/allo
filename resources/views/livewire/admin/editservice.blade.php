		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
					...
					<form method="post" action="{{route('service.update',$list->id)}}" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
    {{ csrf_field() }}
                    <div class="form-group">
						...
						<div class="form-group">
                            ...
                            @if($list->image != '' || $list->image != NULL )
                                &nbsp;&nbsp;&nbsp;
                                <a onclick="return confirm('Are you sure you want to delete this item?');" href="{{ url('service/deleteimage/'.$list->id) }}" rel="{{$list->id}}" rel1="delete-image" class="btn btn-link">Delete Old Image</a>                              
